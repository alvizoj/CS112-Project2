...
NOTES:
    - All but 1 chair correctly face the table.
...
function draw() { 
    ...
    */
    ...
    translate(modelview,modelview,[-0.4,0.0,-2.0]);
    rotate(modelview,modelview,degToRad(-270), [0,1,0]);
    ...
    currentModelNumber = 0;
    update_uniform(modelview,projection, 0);
    translate(modelview,modelview, [-0.60,0.0,-2.6]);
    rotate(modelview,modelview, degToRad(-270), [0,1,0]);
    ...
    currentModelNumber = 0;
    update_uniform(modelview,projection, 0);
    translate(modelview, modelview, [-1.4, 0.0, -1.4]);
    ...
    currentModelNumber = 0;
    update_uniform(modelview,projection, 0);
    translate(modelview, modelview, [-0.20, 0.6, 0.50]);
    ...
    translate(modelview, modelview, [0.3,1.4,0.25]);
